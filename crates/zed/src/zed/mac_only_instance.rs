...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Clay Editor Dev Instance Running",
        ReleaseChannel::Nightly => "Clay Editor Nightly Instance Running",
        ReleaseChannel::Preview => "Clay Editor Preview Instance Running",
        ReleaseChannel::Stable => "Clay Editor Stable Instance Running",
    }
}
