...
use gpui::surface;
use gpui::{
    Anchor, Context, ElementInputHandler, IntoElement, MouseButton, ObjectFit, ParentElement,
    Styled, anchored, canvas, deferred, div, prelude::*, px,
};
use ui::prelude::*;
use ui::{Icon, IconName, IconSize, Tooltip};
        ...
        div()
            ...
            .child(
                div()
                    ...
                    .gap_4()
                    .child(
                        Icon::new(IconName::Public).size(IconSize::Custom(rems(6.0))),
                    )
                    .child(
                        div()
